...
[NDDataArray](xref:api#sdynpy.core.sdynpy_data.NDDataArray) object, users will
utilize the
...
.. figure:: images/Showcase_Time_History_Demo.png
  ...
  [plot](xref:api#sdynpy.core.sdynpy_data.NDDataArray.plot) method.
...
and [pulse](xref:api#sdynpy.signal_processing.sdynpy_generator.pulse).
...
.. figure:: images/Showcase_Beam_Response_GUIPlot.png
  ...
  [GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot) allows users to select
...
.. figure:: images/Showcase_Beam_Plot_Transient.png
  ...
  [TransientPlotter](xref:api#sdynpy.core.sdynpy_geometry.TransientPlotter)
...
.. figure:: images/Showcase_Beam_GUIPlot_FRFs.png
  ...
  [GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot).
...
plots to appear in a [GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot) window.
...
using the
[sdpy.data.load](xref:api#sdynpy.core.sdynpy_data.NDDataArray.load) function.
...
[plot_deflection_shape](xref:api#sdynpy.core.sdynpy_geometry.Geometry.plot_deflection_shape)
method of the [Geometry](xref:api#sdynpy.core.sdynpy_geometry.Geometry) class.
This method accepts a set of spectral data, such as frequency response functions.
However, because the
[DeflectionShapePlotter](xref:api#sdynpy.core.sdynpy_geometry.DeflectionShapePlotter)
...
[PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI) class.  The class
...
Alternatively, [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
...
[PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI).

The initial [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI) window
is shown below.
...
.. figure:: images/Showcase_Beam_PolyPy_Initial.png
  ...
  Initial window of the [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
...
[PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI) implementation in
...
are performed, the [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
...
In the [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI), poles are
selected by clicking on the markers on the stabilization diagram.  When hovering
the mouse over a marker, [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
...
As modes are selected, the [PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
...
[PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI) will resynthesize
...
[GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot) window.  Let's click the
...
[PolyPy_GUI](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI)
using its
[set_geometry](xref:api#sdynpy.modal.sdynpy_polypy.PolyPy_GUI.set_geometry)
...
[SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI) class.  Again, we can
assign geometry directly to the [SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI)
...
Similarly to PolyPy, the [SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI)
...
.. figure:: images/Showcase_Beam_SMAC_Pseudoinverse.png
  ...
  ``Pseudoinverse`` tab in [SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI)
...
.. figure:: images/Showcase_Beam_SMAC_CorrCoef.png
  ...
  [SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI)
...
[SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI) has made very good
...
[SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI) will proceed to the final
...
[GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot) window plotting the
...
The [SMAC_GUI](xref:api#sdynpy.modal.sdynpy_smac.SMAC_GUI) ``Add`` button
...
use the [sdpy.shape.load](xref:api#sdynpy.core.sdynpy_shape.ShapeArray.load)
...
[sdpy.shape.mac](xref:api#sdynpy.core.sdynpy_shape.mac) function.  The matrix
can be plotted using the
[sdpy.matrix_plot](xref:api#sdynpy.signal_processing.sdynpy_correlation.matrix_plot)
function.
...
[sdpy.shape.shape_comparison_table](xref:api#sdynpy.core.sdynpy_shape.shape_comparison_table)
...
[sdpy.Geometry.overlay_geometries](xref:api#sdynpy.core.sdynpy_geometry.Geometry.overlay_geometries)
and
[sdpy.shape.overlay_shapes](xref:api#sdynpy.core.sdynpy_shape.ShapeArray.overlay_shapes)
functions.
Note that the
[sdpy.shape.overlay_shapes](xref:api#sdynpy.core.sdynpy_shape.ShapeArray.overlay_shapes)
...
modal damping. The [System](xref:api#sdynpy.core.sdynpy_system.System) object
has an
[assign_modal_damping](xref:api#sdynpy.core.sdynpy_system.System.assign_modal_damping)
...
[concatenate](xref:api#sdynpy.core.sdynpy_system.System.concatenate) class
method of [System](xref:api#sdynpy.core.sdynpy_system.System).  Note that this
does not actually attach either structure to the other.  It simply puts them in
the same [System](xref:api#sdynpy.core.sdynpy_system.System) object.  If we
...
[concatenate](xref:api#sdynpy.core.sdynpy_system.System.concatenate)
...
[substructure_by_coordinate](xref:api#sdynpy.core.sdynpy_system.System.substructure_by_coordinate)
method of the [System](xref:api#sdynpy.core.sdynpy_system.System)
object, it can also apply constraints automatically based on coincident geometry
using the
[substructure_by_position](xref:api#sdynpy.core.sdynpy_system.System.substructure_by_position)
class method of the [System](xref:api#sdynpy.core.sdynpy_system.System).
...
[substructure_by_position](xref:api#sdynpy.core.sdynpy_system.System.substructure_by_position)
class method of the [System](xref:api#sdynpy.core.sdynpy_system.System).  The
[TransferFunctionArray](xref:api#sdynpy.core.sdynpy_data.TransferFunctionArray)
class also has a
[substructure_by_coordinate](xref:api#sdynpy.core.sdynpy_data.TransferFunctionArray.substructure_by_coordinate)
...
[GUIPlot](xref:api#sdynpy.core.sdynpy_data.GUIPlot) will allow easy comparisons
between functions.
